    ...
    items: [
     {
        key: 'B1',
        label: 'B1',
        text: '아침에 기상 후 통증이 있으시다면 어느정도 인가요?',
      },
      {
        key: 'B2',
        label: 'B2',
        text: '점심 즈음에 통증이 있으시다면 어느정도 인가요?',
      },
      {
        key: 'B3',
        label: 'B3',
        text: '저녁 즈음에 통증이 있으시다면 어느정도 인가요?',
      },
    ],
  },
];
...
export default function PainScaleScreen() {
  ...
  const [answers, setAnswers] = useState({ B1: null, B2: null, B3: null });
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('./pressurepain')}
        >
